...
class Test_Integration(unittest.TestCase):
    ...
    def test_compare_integration1(self): 
        ...
        integral_out, _ = gp.integral_grad(lplus = t)
        integral_out = integral_out.numpy()
        
        #print(get_numerical_integral_benchmark(gp, t))
        self.assertAlmostEqual( integral_out, 0.5915594883938603, places=7)
    ...
    def test_compare_integration2(self): 
        ...
        #print(get_numerical_integral_benchmark(gp, t))
        self.assertAlmostEqual( integral_out, 18.174181042785875, places=7)
    ...
    def test_compare_integration3(self): 
        ...
        #print(get_numerical_integral_benchmark(gp, t))
        self.assertAlmostEqual( integral_out, 2.182731142904413, places=7)
